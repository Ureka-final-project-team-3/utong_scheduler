//package com.ureka.team3.utong_scheduler.chart.scheduler;
//
...
//
//        // Redis 메시지는 1번만 발행
//        verify(aggregationPublisher, times(1))
//                .publishAggregationComplete(any(LocalDateTime.class));
//        verify(aggregationPublisher, never())
...
//        verify(aggregationPublisher).publishAggregationComplete(
//                argThat(aggregatedAt ->
//                        aggregatedAt.getMinute() == 0 &&
//                                aggregatedAt.getSecond() == 0 &&
//                                aggregatedAt.getNano() == 0
...
//                .when(aggregationPublisher).publishAggregationComplete(any());
//
