...
public class AggregationPublisher implements RedisPublisher <Map<String, List<AvgPerHour>>>{
    ...
    @Override
    public void publish(LocalDateTime aggregatedAt, Map<String, List<AvgPerHour>> dataMap) {
        try {
